...
import Input from './backoffice/Input';
...
class AddpanelPie extends Component {
    ...
    dipslayInputs = () => {
        ...
        for (let i=0 ; i < numbOfInputs ; i++) {
            ...
            listOfInputs.push(<Inputs  value ={this.state.localname}  onChange={this.onChange} description={localname} index = {i} key={i}/>); //list of inputs
